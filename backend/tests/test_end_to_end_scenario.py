...
@pytest.mark.asyncio
async def test_full_scenario_txn_4999_upi(async_client):
    """
    ...
    res_analyze = await async_client.post("/api/recovery/analyze", json={"transaction_id": "txn_4999_upi"})
    ...
    res_audit = await async_client.get("/api/audit-logs/verify")
